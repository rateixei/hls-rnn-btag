...
def plotRoc(y, predict_test, linestyle, legend=True):
    ...
    plt.plot( hist_b_bvl_eff, hist_l_bvl_eff, label=f'b vs l (pb/pl), AUC = {auc_bvl:.4f}', linestyle=linestyle )
    plt.plot( hist_b_bvc_eff, hist_c_bvc_eff, label=f'b vs c (pb/pc), AUC = {auc_bvc:.4f}', linestyle=linestyle )
