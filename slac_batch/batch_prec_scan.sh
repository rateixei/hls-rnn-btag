...
for prec1 in 16 18 20 22 24 26 28 30
do
    ...
    do
        ...
        do
            ...
            do
                ...
                jname=${MOD}_${prec1}_${prec2}_${prec3}_${prec4}_${STRAT}
                job="./submit_script.sh ${KERAS_LOC} ${MOD} ${prec1} ${prec2} ${prec3} ${prec4} ${REUSE} ${STRAT}"
